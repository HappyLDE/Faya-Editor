...
static const LDEfloat EPSILON=0.0000000001f;
...
/*
 ...
 defined by A, B, C.
 */
bool Triangulate::InsideTriangle(LDEfloat Ax, LDEfloat Ay,
                                 LDEfloat Bx, LDEfloat By,
                                 LDEfloat Cx, LDEfloat Cy,
                                 LDEfloat Px, LDEfloat Py)

{
    LDEfloat ax, ay, bx, by, cx, cy, apx, apy, bpx, bpy, cpx, cpy;
    LDEfloat cCROSSap, bCROSScp, aCROSSbp;
...
{
    int p;
    LDEfloat Ax, Ay, Bx, By, Cx, Cy, Px, Py;
